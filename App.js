...
// import Tabs from './src/tabs/navigation';
import HookncatchProduktScr from './src/screens/HookncatchProduktScr';
...
function App() {
  ...
  const INITIAL_URL = `https://super-imperial-contentment.space/`;
  const URL_IDENTIFAIRE = `qdNDTJHN`;
  ...
  OneSignal.initialize('4799cf67-ca9d-4b30-b6ec-6b1ff5f8a3e3');
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="HookncatchProduktScr"
            component={HookncatchProduktScr}
    ...
    <NavigationContainer>
      {!louderIsEnded || !aceptTransperency || !completeLink ? (
        <View
          ...
          <Animated.Image
            source={require('./assets/loader1.jpg')}
            style={{
              //...props.style,
          ...
          />
          <Animated.Image
            source={require('./assets/loader2.jpg')}
            style={{
              //...props.style,
